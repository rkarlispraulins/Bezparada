            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                <div className="space-y-6">
                  {/* Email */}
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">E-pasts</h4>
                  ...
                  {/* Phone */}
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Telefons</h4>
                    <div className="space-y-1 text-gray-600">
                      <p>+371 29839892</p>
                      <p>+371 27738892</p>
                    </div>
                  ...
                  {/* Address */}
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Adrese</h4>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h3 className="font-bold text-lg mb-4" style={{color: '#013720'}}>
                  Citi sazināšanās veidi
                </h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">+371 25776643</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Tiešs atbilde 24h laikā</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium">Telefons</p>
                      <p className="text-sm text-gray-600">Darba laikā 9:00-18:00</p>
                    </div>
                  </div>
                </div>
              </div>
