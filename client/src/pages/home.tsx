      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="main-container mx-auto px-4 sm:px-6 lg:px-8 max-w-[800px]">
          ...
          <div className="mt-16 lg:mt-24">
            <div className="bg-white rounded-3xl p-8 lg:p-12 mx-4 sm:mx-6 lg:mx-8">
              ...
              {/* Bottom Row */}
              <div className="flex flex-col lg:flex-row justify-between items-center mt-8 lg:mt-12 pt-6 border-t border-gray-200">
                <p className="text-gray-500 text-sm mb-4 lg:mb-0">© ZAB "Krūmiņš", 2025. Visas tiesības aizsargātas.</p>
                
                {/* Social Icons */}
                <div className="flex items-center gap-4">
                  <a href="#" className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded hover:bg-gray-50">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H6.5v-7H9v7zM7.75 8.5c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25zM18 17h-2.5v-3.5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5V17H10v-7h2.5v1.25c.5-.81 1.69-1.25 2.5-1.25 1.93 0 3 1.57 3 3.5V17z"/>
                    </svg>
                  </a>
                  <a href="#" className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded hover:bg-gray-50">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
