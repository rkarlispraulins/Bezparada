...
import JuridiskasPersonas from "@/pages/juridiskas-personas";
...
import { Paldies } from "@/pages/paldies";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/juridiskas-personas-maksatnespeja" component={JuridiskasPersonas} />
      ...
      <Route path="/paldies" component={Paldies} />
